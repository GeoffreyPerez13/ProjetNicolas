...
<!-- Mobile toggle -->
<button class="admin-mobile-toggle" aria-label="Menu">
...
<aside class="admin-sidebar" id="adminSidebar">
    ...
    <nav class="sidebar-nav">
        <div class="sidebar-nav-group">
            <div class="sidebar-nav-label">Général</div>
            <a href="<?= baseUrl() ?>/admin/index.php" class="sidebar-link <?= $adminPage === 'index' ? 'active' : '' ?>">
        ...
        <div class="sidebar-nav-group">
            <div class="sidebar-nav-label">Contenu</div>
            <a href="<?= baseUrl() ?>/admin/categories.php" class="sidebar-link <?= $adminPage === 'categories' ? 'active' : '' ?>">
            ...
            <a href="<?= baseUrl() ?>/admin/oeuvres.php" class="sidebar-link <?= $adminPage === 'oeuvres' ? 'active' : '' ?>">
            ...
            <a href="<?= baseUrl() ?>/admin/expositions.php" class="sidebar-link <?= $adminPage === 'expositions' ? 'active' : '' ?>">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 7v10"></path><path d="M6 5v14"></path><rect width="12" height="18" x="10" y="3" rx="2"></rect></svg>
                Expositions
            </a>
            <a href="<?= baseUrl() ?>/admin/banner.php" class="sidebar-link <?= $adminPage === 'banner' ? 'active' : '' ?>">
            ...
            <a href="<?= baseUrl() ?>/admin/timeline.php" class="sidebar-link <?= $adminPage === 'timeline' ? 'active' : '' ?>">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 8v4l3 3"></path><circle cx="12" cy="12" r="10"></circle></svg>
                Timeline / CV
            </a>
        </div>

        <div class="sidebar-nav-group">
            <div class="sidebar-nav-label">Apparence</div>
            <a href="<?= baseUrl() ?>/admin/settings.php" class="sidebar-link <?= $adminPage === 'settings' ? 'active' : '' ?>">
            ...
            <a href="<?= baseUrl() ?>/admin/footer.php" class="sidebar-link <?= $adminPage === 'footer' ? 'active' : '' ?>">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2"></rect><path d="M3 15h18"></path></svg>
                Footer
            </a>
            <a href="<?= baseUrl() ?>/admin/social.php" class="sidebar-link <?= $adminPage === 'social' ? 'active' : '' ?>">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" x2="21" y1="14" y2="3"></line></svg>
                Réseaux sociaux
            </a>
        </div>
    </nav>
    ...
    <div class="sidebar-footer">
        ...
        <a href="<?= baseUrl() ?>/admin/profile.php" style="margin-top:0.5rem;">
        ...
        <a href="<?= baseUrl() ?>/admin/logout.php" style="margin-top:0.5rem;">
